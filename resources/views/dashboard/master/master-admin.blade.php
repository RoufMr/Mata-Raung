...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('sipenmaru/images/logo_nonbg.png') }}">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="dashboard" class="brand-logo">
                <img alt="image" width="40" src="{{ asset('sipenmaru/images/logo_nonbg.png') }}">
                <div class="brand-title">
                    <h2 class="">MATA RAUNG</h2>
                </div>
            </a>
        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                ...
                <div class="side-bar-profile">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="profile-info1">
                            <h4 class="fs-18 font-w500">nama</h4>
                            <span>email</span>
                        </div>
                ...
                <div class="copyright">
                    <p><strong>MATA RAUNG INDONESIA</strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved</p>
                    <p class="fs-12">Made with<span class="heart"></span> by Mata Raung</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/mataraung/" target="_blank">Mata Raung Indonesia</a>
                </p>
            </div>
        </div>
        <!--**********************************
...
<script>
    $(document).on('change', '.toggle-status', function () {
        ...
        $.ajax({
            url: "{{ route('blog.updateStatus') }}",// "",  // Pastikan membuat route ini
            method: 'POST',
            data: {
                _token: "{{ csrf_token() }}",
                id: id,
