                ...
                <div class="sidebar-textwidget">
                    <div class="sidebar-info-contents">
                        <div class="content-inner">
                            <div class="logo">
                                <a href="/"><img src="{{ asset('assets/img/resource/logo-1.png') }}" alt="" /></a>
                            </div>
                        ...
                        <div class="container">
                            <div class="main-header-three__inner">
                                ...
                                <div class="main-header-three__top">
                                    <div class="main-header-three__top-pattern" style="background-image: url('{{ asset('assets/img/pattern/header-v3-pattern.png') }}');">
                                    </div>
                                    <div class="main-header-three__top-inner">
                                                ...
                                                <ul class="clearfix">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="text-box">
                                                            <p>Email</p>
                                                            <h4>
                                                                <a href="mailto:mataraung@email.com">mataraung@gmail.com
                                                                </a>
                                                            </h4>
                                                        </div>
                                                    </li>
                                        ...
                                        <div class="main-header-three__top-right">
                                            ...
                                            <div class="social-links">
                                                <a href="https://www.tiktok.com/@mataraung?lang=id-ID&is_from_webapp=1&sender_device=mobile&sender_web_id=7510456609338148370"><span class="fab fa-tiktok"></span></a>
                                ...
                                <div class="main-header-three__bottom clearfix">
